          ...
          >
            <div className="bg-white bg-opacity-85 p-6 sm:p-8 lg:p-[25px] rounded-lg shadow-lg space-y-1 sm:space-y-2" style={{ transform: 'translateZ(50px)' }}>
              ...
              <div className="flex justify-center gap-5">
                <Link
                  to="/menu"
                  className="inline-block mr-16 px-6 py-2 sm:px-8 sm:py-3 bg-gradient-to-r from-yellow-400 to-yellow-500 text-white rounded-full font-semibold hover:from-yellow-500 hover:to-yellow-600 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 text-sm sm:text-base"
              >
                Vezi meniul nostru
                </Link>
